...
<body>
    ...
    if(isset($_GET['opportunity_id'])) {
        ...
        $sql = "SELECT u.user_id, u.first_name, u.last_name, u.email, u.profile_photo FROM users u
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                // Wrap user card elements in an anchor tag
                echo "<a href='view-profile.php?user_id=" . $row['user_id'] . "' class='user-card'>";
